...
<head>
    ...
    <script type="text/javascript">
        ...
        function adress_search(){
            window.open("search_adress.php","","width=600px, height=250px, left=0, top=0")
        };
        function del_check(){
            var i = confirm("정말 탈퇴하시겠습니까? 탈퇴한 아이디는 사용하실 수 없습니다.");
            if(i){
    ...
    <form name="edit_form" action="edit_check.php" method="post" onsubmit="return edit_check()">
        <fieldset>
            ...
            <p>
                ...
                <button type="button" onclick="del_check()">회원 탈퇴</button>
            </p>
